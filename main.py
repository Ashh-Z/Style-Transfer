...
if __name__ == '__main__' : 
    ...
    parser.add_argument('--style_img_pth',required=True)
    parser.add_argument('--content_img_pth',required=True)
    parser.add_argument('--image_size', default=224, required=True)
